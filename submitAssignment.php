...
</ol></div><div class="box"><h1>Test </h1><ol class="examLink"><li class="title summary">Exam III Friday the 27th</li></ol></div></aside><section id='submit'>
<h1>Student: <a target='_blank' href='https://rmccague.w3.uvm.edu/cs142'> Ryan J. McCague</a></h1>
...
<option value='-1' selected='selected'>Choose Assignment</option>
				...
				<option value='28' >Style Before and After</option>
</select>
...
<input type="hidden" name="hiddenToken" value="35a544dcecea77411748e2b16ee6550dc08dcff8">
</form>
