...
<span id="studentGrade" >Current <a href="https://rerickso.w3.uvm.edu/education/blackboard/grades.php">Grade</a>: 71.3</span>
<span id="classRank">
Rank: 35 of 44
</span>
</aside> <!-- %^%^%^%^%^ student info %^%^%^%^%^ -->
...
<p>CRN: 11783 MWF starting at 12:50 to 01:40 in room KALKIN 001 - Spring - 2015</p>
<h2>Description</h2>
...
<article id="tahours">
    ...
    <div class="dayColumn">
        <div class="header">Monday<br>2015-03-16</div><a href="requestTa.php?aid=7&amp;dateValue=1426478400"><div class="hourBox" style="top: 0px; height: 120px;"><span class="startTime">10:00</span><span class="taName">Jenny</span><span class="where">Votey 351 A</span><span class="endTime">12:00</span></div></a><div class="filler" style="top: 120px; height: 60px;"></div><a href="requestTa.php?aid=3&amp;dateValue=1426478400"><div class="hourBox" style="top: 180px; height: 180px;"><span class="startTime">1:00</span><span class="taName">Karol</span><span class="where">Votey 347</span><span class="endTime">4:00</span></div></a><a href="requestTa.php?aid=1&amp;dateValue=1426478400"><div class="hourBox" style="top: 360px; height: 50px;"><span class="startTime">1:55</span><span class="taName">Bob</span><span class="where">Votey 331</span><span class="endTime">2:45</span></div></a><a href="requestTa.php?aid=13&amp;dateValue=1426478400"><div class="hourBox" style="top: 410px; height: 120px;"><span class="startTime">4:00</span><span class="taName">Simon</span><span class="where">Votey 351 A</span><span class="endTime">6:00</span></div></a><a href="requestTa.php?aid=13&amp;dateValue=1426478400"><div class="hourBox" style="top: 530px; height: 180px;"><span class="startTime">5:30</span><span class="taName">Simon</span><span class="where">Votey 351 A</span><span class="endTime">8:30</span></div></a></div> <!-- Monday --><div class="dayColumn">
        <div class="header">Tuesday<br>2015-03-17</div><a href="requestTa.php?aid=2&amp;dateValue=1426564800"><div class="hourBox" style="top: 0px; height: 75px;"><span class="startTime">10:00</span><span class="taName">Jen</span><span class="where">Votey 351 A</span><span class="endTime">11:15</span></div></a><div class="filler" style="top: 75px; height: 195px;"></div><a href="requestTa.php?aid=8&amp;dateValue=1426564800"><div class="hourBox" style="top: 270px; height: 120px;"><span class="startTime">2:30</span><span class="taName">Nick</span><span class="where">Votey 351 A</span><span class="endTime">4:30</span></div></a></div> <!-- Tuesday --><div class="dayColumn">
        <div class="header">Wednesday<br>2015-03-18</div><div class="filler" style="top: 0px; height: 120px;"></div><a href="requestTa.php?aid=7&amp;dateValue=1426651200"><div class="hourBox" style="top: 120px; height: 150px;"><span class="startTime">12:00</span><span class="taName">Jenny</span><span class="where">Votey 351 A</span><span class="endTime">2:30</span></div></a><a href="requestTa.php?aid=1&amp;dateValue=1426651200"><div class="hourBox" style="top: 270px; height: 50px;"><span class="startTime">1:55</span><span class="taName">Bob</span><span class="where">Votey 331</span><span class="endTime">2:45</span></div></a><div class="filler" style="top: 320px; height: 40px;"></div><a href="requestTa.php?aid=13&amp;dateValue=1426651200"><div class="hourBox" style="top: 360px; height: 120px;"><span class="startTime">4:00</span><span class="taName">Simon</span><span class="where">Votey 351 A</span><span class="endTime">6:00</span></div></a></div> <!-- Wednesday --><div class="dayColumn">
        <div class="header">Thursday<br>2015-03-12</div><div class="filler" style="top: 0px; height: 180px;"></div><a href="requestTa.php?aid=2&amp;dateValue=1426132800"><div class="hourBox" style="top: 180px; height: 165px;"><span class="startTime">1:00</span><span class="taName">Jen</span><span class="where">Votey 351 A</span><span class="endTime">2:45</span></div></a><a href="requestTa.php?aid=7&amp;dateValue=1426132800"><div class="hourBox" style="top: 345px; height: 90px;"><span class="startTime">2:15</span><span class="taName">Jenny</span><span class="where">Votey 351 A</span><span class="endTime">3:45</span></div></a><a href="requestTa.php?aid=4&amp;dateValue=1426132800"><div class="hourBox" style="top: 435px; height: 90px;"><span class="startTime">4:00</span><span class="taName">Kylie</span><span class="where">Votey 351 A</span><span class="endTime">5:30</span></div></a></div> <!-- Thursday --><div class="dayColumn">
        <div class="header">Friday<br>2015-03-13</div></div> <!-- Friday -->        
</article>
